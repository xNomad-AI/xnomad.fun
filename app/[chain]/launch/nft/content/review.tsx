...
import { IssueTokenForm } from "@/app/[chain]/agent/[address]/chat/content/issue-token/form";
import { PoweredBy } from "@/app/[chain]/agent/[address]/chat/content/issue-token/powered-by";
...
export function Review({
  ...
  const getMintFee = useMemoizedFn(async (chain: SupportedChain) => {
        ...
        <div className='w-full flex flex-col gap-16'>
          <div className='flex items-center justify-between w-full'>
            ...
            <p className={"font-bold"}>
              ...
              {(mintFee?.discountPercentage ?? 0) > 0 && (
                <span>
                  &nbsp;{mintFee?.feeAfterDiscount} {getCurrencySymbol(chain)}
                </span>
              )}
            </p>
          </div>
