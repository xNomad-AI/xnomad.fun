...
export function BaseTemplate({
    ...
    const { tradeSettingModalController, slippage, priorityFee, tradeMode } = useTradeConfigStore();
    return (
        <>
            ...
            {tradeMode === "ANTI-MEV" && value && mevWarning ? (
                ...
                >
                    <span className="text-size-12 text-red">Anti-MEV mode is enabled to ensure safety.</span>
            ...
            <div className="flex flex-col gap-col">
              ...
              <TokenNumber className='inline-flex' number={priorityFee} />
                    ...
                    <div className="flex items-center justify-between gap-16">
                        <div>
                            Mode: {tradeMode === "ANTI-MEV" ? <span className="text-red">Anti-MEV</span> : <span className="text-text1">Fast</span>}
                        </div>
                        <button
                            onClick={() => {
                                tradeSettingModalController.setTrue();
