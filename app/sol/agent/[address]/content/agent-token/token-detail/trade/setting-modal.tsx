...
import { Button, IconInfo, Modal, ModalContent, ModalTitleWithBorder, Radio, RadioGroup, TextField, Tooltip } from "@/primitive/components";
...
export function TradeSettingModal() {
    ...
    return (
        <Modal open={tradeSettingModalVisible} onMaskClick={tradeSettingModalController.setFalse} size="s">
            <ModalTitleWithBorder closable onClose={tradeSettingModalController.setFalse}>
                Setting
            ...
            <ModalContent className="!gap-16">
                <div className="flex flex-col gap-8 w-full">
                    ...
                    <div className="flex items-center gap-16">
                        <RadioGroup value={isFastMode ? "FAST" : "ANTI-MEV"} className="gap-16">
                            <Radio value="FAST" checked={isFastMode} onChange={() => setInnerTradeMode("FAST")}>
                            ...
                            <Radio value="ANTI-MEV" checked={!isFastMode} onChange={() => setInnerTradeMode("ANTI-MEV")}>
                                <div className="flex items-center gap-8">
                                    Anti-MEV{" "}
            ...
            {!isFastMode ? (
              ...
              <>
                ...
                <div className="flex flex-col gap-8 w-full">
                    ...
                    />
                    {showTipError ? <span className="text-size-12 text-red">{`Please increase to >=${MIN_TIP} for better performance.`}</span> : null}
                </div>
                <div className="flex items-center w-full gap-16">
                    <Button variant="secondary" stretch onClick={tradeSettingModalController.setFalse}>
                        Cancel
                    </Button>
